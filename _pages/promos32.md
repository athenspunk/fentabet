...
.layout--generic-block .head-section--title {
    font-family: "Druk Wide LCG App-Medium";
    color: #fff;
    text-align: left;
    padding: 5px;
...
.layout--generic-block .cta-container a {
    color: #000;
    font-weight: bold;
    font-size: 17px;
    background: #fc0;
...
@media only screen and (min-width: 769px) {
    ...
    .layout--generic-block .head-section--title-2 h1 span { 
       font-size: 35px;
       vertical-align: 14px;
    }
